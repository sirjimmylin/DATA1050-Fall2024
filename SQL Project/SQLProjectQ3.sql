...
FROM physicians
INNER JOIN prescriptions ON prescriptions.physician_id = physicians.ssn
INNER JOIN drugs ON drugs.name = prescriptions.drug_name
INNER JOIN contracts ON contracts.drug_name = drugs.name
